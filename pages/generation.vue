        ...
        <main class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
            <div class="flex items-center gap-x-2">
                <div class="flex-grow rounded-md bg-white px-3 pb-1.5 pt-2.5 shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-indigo-600">
                    ...
                    <input @keyup.enter="$event.target.blur();getData()" v-model="inputValue" type="text" name="name" id="name" class="focus:outline-none block w-full border-0 p-0 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                ...
                <div class=" rounded-md bg-white px-3 pb-1.5 pt-2.5 shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-indigo-600">
                    ...
                    <input @keyup.enter="$event.target.blur();getData()" v-model="inputNumber" type="number" name="number" id="number" class="focus:outline-none block w-full border-0 p-0 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                           placeholder="5"/>
                </div>
            </div>
